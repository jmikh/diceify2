...
export default function Footer() {
  ...
  return (
    <>
      <footer id="about" className="relative z-10 py-10 px-6 md:px-24 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-[var(--border-glass)]">
